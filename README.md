...
Комментарий специально для автора проекта!!!!!!!!

Можешь удалить полностью SFML из проекта, и поменять ход установки в Windows.
В зависимости от Операционной системы пользователь скачает версию SFML и просто добавит в проект 
и будет пользоваться им.